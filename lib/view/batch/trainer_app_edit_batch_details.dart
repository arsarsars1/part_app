...
class TrainerAppEditBatchDetails extends StatefulWidget {
  ...
  State<TrainerAppEditBatchDetails> createState() =>
      _TrainerAppEditBatchDetailsState();
}

class _TrainerAppEditBatchDetailsState
    extends State<TrainerAppEditBatchDetails> {
      ...
      body: BlocListener<BatchCubit, BatchState>(
        listener: (context, state) {
          if (state is UpdatingBatch) {
            ...
            Navigator.popUntil(
              context,
              ModalRoute.withName(TrainerAppBatchDetails.route),
            );
