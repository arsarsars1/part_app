...
class _TrainerAppAddBatchState extends State<TrainerAppAddBatch> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      context.read<BatchCubit>().getCoursesForTrainer(
            acadamyId: authCubit
                    ?.user
      ...
      setState(() {
        branchCubit.getBranchTrainersForTrainer(
          trainerId: authCubit
