...
class ManagerAppEditBatchDetails extends StatefulWidget {
  static const route = '/batch/details/manager-app-edit';

  const ManagerAppEditBatchDetails({super.key});

  @override
  State<ManagerAppEditBatchDetails> createState() =>
      _ManagerAppEditBatchDetailsState();
}

class _ManagerAppEditBatchDetailsState
    extends State<ManagerAppEditBatchDetails> {
      ...
      body: BlocListener<BatchCubit, BatchState>(
        listener: (context, state) {
          if (state is UpdatingBatch) {
            ...
            Navigator.popUntil(
              context,
              ModalRoute.withName(ManagerAppEditBatchDetails.route),
            );
