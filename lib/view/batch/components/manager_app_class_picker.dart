...
class ManagerAppClassPicker extends StatefulWidget {
  final int? branchId;
  final int? batchId;
  final String? date;
  ...
  @override
  State<ManagerAppClassPicker> createState() => _ManagerAppClassPickerState();
}

class _ManagerAppClassPickerState extends State<ManagerAppClassPicker> {
  ...
  void initState() {
    ...
    context.read<BranchCubit>().getBatchClassesOfDateForManager(
          managerId: authCubit
