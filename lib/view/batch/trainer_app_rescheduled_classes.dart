...
class TrainerAppRescheduledClasses extends StatefulWidget {
  static const route = '/trainer-app-batch/rescheduled-classes';

  const TrainerAppRescheduledClasses({Key? key}) : super(key: key);

  @override
  State<TrainerAppRescheduledClasses> createState() =>
      _TrainerAppRescheduledClassesState();
}

class _TrainerAppRescheduledClassesState
    extends State<TrainerAppRescheduledClasses> {
  AuthCubit? authCubit;
  @override
  void initState() {
    super.initState();
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      context.read<BatchCubit>().getRescheduledBatchesForTrainer(
            trainerId: authCubit
