...
class ManagerAppRescheduleClass extends StatefulWidget {
  static const route = '/manager-app-batch/reschedule-class';

  const ManagerAppRescheduleClass({super.key});

  @override
  State<ManagerAppRescheduleClass> createState() =>
      _ManagerAppRescheduleClassState();
}

class _ManagerAppRescheduleClassState extends State<ManagerAppRescheduleClass> {
  String? startTime;
  String? endTime;
  String? startDate;
  String? endDate;
                    ...
                    Expanded(
                      child: ScheduleField(
                        ...
                        onSelect: (String value) async {
                          ...
                          await context
                              .read<BranchCubit>()
                              .getBranchClassesOfDateForManager(
                                managerId: authCubit
                                        ?.user
                                        ?.managerDetail?[
