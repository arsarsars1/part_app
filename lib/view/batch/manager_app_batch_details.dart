...
class ManagerAppBatchDetails extends StatefulWidget {
  static const route = '/manager-app-batch/details';

  const ManagerAppBatchDetails({super.key});

  @override
  State<ManagerAppBatchDetails> createState() => _ManagerAppBatchDetailsState();
}

class _ManagerAppBatchDetailsState extends State<ManagerAppBatchDetails> {
  bool isActive = true;
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        Navigator.pushNamed(
                                          context,
                                          ManagerAppEditBatchDetails.route,
                                        );
                                      },
                                      child: Container(
                                        width: 24.w,
