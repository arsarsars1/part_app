...
class ManagerAppEditLead extends StatefulWidget {
  static const route = '/leads/manager-app-lead-edit';

  const ManagerAppEditLead({super.key});

  @override
  State<ManagerAppEditLead> createState() => _ManagerAppEditLeadState();
}

class _ManagerAppEditLeadState extends State<ManagerAppEditLead> {
  String? status;
  String? name;
  String? age;
  String? gender;
                      ...
                      child: Button(
                        onTap: () {
                          if (formKey.currentState!.validate()) {
                            ...
                            context.read<LeadsCubit>().updateForManager(
                                  request,
                                  id,
                                  managerId: authCubit
                                          ?.user
