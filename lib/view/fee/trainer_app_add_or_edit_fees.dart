...
class TrainerAppAddOrEditFees extends StatefulWidget {
  static const route = '/trainer-app-fees/add-fees';
  const TrainerAppAddOrEditFees({super.key});

  @override
  State<TrainerAppAddOrEditFees> createState() =>
      _TrainerAppAddOrEditFeesState();
}

class _TrainerAppAddOrEditFeesState extends State<TrainerAppAddOrEditFees> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      await feeCubit?.getBatchInvoiceForTrainer(
      ...
      body: BlocConsumer<FeeCubit, FeeState>(
        listener: (context, state) {
          if (state is AddedFees) {
            ...
            feeCubit?.getBatchInvoiceForTrainer(
              batchInvoiceId: feeCubit?.student.id,
              trainerId: authCubit
