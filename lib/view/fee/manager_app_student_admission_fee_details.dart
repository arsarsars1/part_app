...
import 'package:part_app/view/fee/components/manager_app_admission_fee_list_item.dart';
...
class ManagerAppStudentAdmissionFeeDetails extends StatefulWidget {
  static const route = '/manager-student-admission-fee-details';

  const ManagerAppStudentAdmissionFeeDetails({super.key});

  @override
  State<ManagerAppStudentAdmissionFeeDetails> createState() =>
      _ManagerAppStudentAdmissionFeeDetailsState();
}

class _ManagerAppStudentAdmissionFeeDetailsState
    extends State<ManagerAppStudentAdmissionFeeDetails> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      context.read<FeeCubit>().getAdmissionFeeDetailsManagerApp(
          managerId: authCubit
      ...
      body: BlocConsumer<FeeCubit, FeeState>(
        listener: (context, state) {
          ...
          if (state is FeeReminderSent) {
            ...
            cubit.getAdmissionFeeDetailsManagerApp(
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    //           status = 'all';
                    //         });
                    //         cubit.getAdmissionFeeDetailsTrainerApp(
                    //             feeType: feeType,
                    //             searchQuery: query,
                    //             paymentStatus: status,
                    //             studentId: context
