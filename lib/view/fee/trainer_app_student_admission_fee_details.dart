...
import 'package:part_app/view/fee/components/trainer_app_admission_fee_list_item.dart';
...
class TrainerAppStudentAdmissionFeeDetails extends StatefulWidget {
  static const route = '/trainer-student-admission-fee-details';

  const TrainerAppStudentAdmissionFeeDetails({super.key});

  @override
  State<TrainerAppStudentAdmissionFeeDetails> createState() =>
      _StudentAdmissionFeeDetailsState();
}

class _StudentAdmissionFeeDetailsState
    extends State<TrainerAppStudentAdmissionFeeDetails> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      context.read<FeeCubit>().getAdmissionFeeDetailsTrainerApp(
          trainerId: authCubit
