...
class TrainerAppAddAdvanceFeePage extends StatefulWidget {
  static const route = '/trainer-app-add-advance-fee';
  const TrainerAppAddAdvanceFeePage({Key? key}) : super(key: key);

  @override
  State<TrainerAppAddAdvanceFeePage> createState() =>
      _TrainerAppAddAdvanceFeePageState();
}

class _TrainerAppAddAdvanceFeePageState
    extends State<TrainerAppAddAdvanceFeePage> {
                            ...
                            child: Button(
                              onTap: () {
                                if (formKey.currentState!.validate()) {
                                  feeCubit?.addAdvanceFeesForTrainer(
                                      trainerId: authCubit
                                              ?.user
                                              ?.trainerDetail?[
