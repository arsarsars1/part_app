...
class TrainerAppFeeListItem extends StatefulWidget {
  final Datum student;
  final bool isFromAdmission;
  final VoidCallback onTap;

  const TrainerAppFeeListItem({
    Key? key,
  ...
  @override
  State<TrainerAppFeeListItem> createState() => _TrainerAppFeeListItemState();
}

class _TrainerAppFeeListItemState extends State<TrainerAppFeeListItem> {
  bool isShrunk = true;
  AuthCubit? authCubit;
