...
class AdmissionFeeListItem extends StatefulWidget {
  final Datum student;
  final bool isFromAdmission;
  final VoidCallback onTap;

  const AdmissionFeeListItem({
    super.key,
  ...
  @override
  State<AdmissionFeeListItem> createState() => _AdmissionFeeListItemState();
}

class _AdmissionFeeListItemState extends State<AdmissionFeeListItem> {
  bool isShrunk = true;
