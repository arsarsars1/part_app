...
class TrainerAppAdmissionFeeListItem extends StatefulWidget {
  final Datum student;
  final bool isFromAdmission;
  final VoidCallback onTap;

  const TrainerAppAdmissionFeeListItem({
    super.key,
  ...
  @override
  State<TrainerAppAdmissionFeeListItem> createState() =>
      _TrainerAppAdmissionFeeListItemState();
}

class _TrainerAppAdmissionFeeListItemState
    extends State<TrainerAppAdmissionFeeListItem> {
  bool isShrunk = true;
  AuthCubit? authCubit;
                                ...
                                onTap: widget.student.paymentStatus == 'paid'
                                    ...
                                    : () {
                                        if (widget.isFromAdmission) {
                                          feeCubit.sendReminderForAdmissionForTrainer(
                                              trainerId: authCubit
                                                      ?.user
