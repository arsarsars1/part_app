...
class ManagerAppAddAdvanceFeePage extends StatefulWidget {
  static const route = '/manager-app-add-advance-fee';
  const ManagerAppAddAdvanceFeePage({super.key});

  @override
  State<ManagerAppAddAdvanceFeePage> createState() =>
      _ManagerAppAddAdvanceFeePageState();
}

class _ManagerAppAddAdvanceFeePageState
    extends State<ManagerAppAddAdvanceFeePage> {
                            ...
                            child: Button(
                              onTap: () {
                                if (formKey.currentState!.validate()) {
                                  feeCubit?.addAdvanceFeesForManager(
                                      managerId: authCubit
                                              ?.user
                                              ?.managerDetail?[
