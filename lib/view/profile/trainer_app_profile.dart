...
class _TrainerAppProfileState extends State<TrainerAppProfile> {
  String? name;
  String? email;
  String? dob;
  String? gender;
        ...
        return Form(
          ...
          child: ListView(
            children: [
                ...
                Column(
                  children: [
                    CommonField(
                      ...
                      initialValue: cubit
                          .user?.trainerDetail?[cubit.trainerIndex].whatsappNo,
                      onChange: (value) {
                        waNumber = value;
                      },
                      hint: 'Eg: 9876543210',
              ...
              CommonField(
                enabled: false,
                initialValue: cubit.user?.trainerDetail?[cubit.trainerIndex]
                    .academy?.academyName,
                title: 'Academy Name',
            ...
            child: Button(
              onTap: () {
                if (formKey.currentState!.validate()) {
                  ...
                  cubit.updateProfileForTrainer(request,
                      cubit.user?.trainerDetail?[cubit.trainerIndex].id ?? 0);
                }
              },
              title: 'Update',
            ),
