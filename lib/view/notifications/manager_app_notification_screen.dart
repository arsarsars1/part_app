...
class ManagerAppNotificationScreen extends StatefulWidget {
  static const route = '/manager-app-notifications';
  const ManagerAppNotificationScreen({super.key});

  @override
  State<ManagerAppNotificationScreen> createState() =>
      _ManagerAppNotificationScreenState();
}

class _ManagerAppNotificationScreenState
    extends State<ManagerAppNotificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        future: cubit.getManagerAppNotificationList(
            managerId: authCubit
          ...
          return BlocConsumer<HomeCubit, HomeState>(
            listener: (context, state) {
              if (state is GetNotificationsFailed) {
                ...
                Alert(context).show(message: state.message);
                cubit.getManagerAppNotificationList(
