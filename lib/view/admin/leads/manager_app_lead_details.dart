...
class ManagerAppLeadDetails extends StatefulWidget {
  static const route = '/leads/manager-app-lead-details';
  const ManagerAppLeadDetails({super.key});

  @override
  State<ManagerAppLeadDetails> createState() => _ManagerAppLeadDetailsState();
}

class _ManagerAppLeadDetailsState extends State<ManagerAppLeadDetails> {
  AuthCubit? authCubit;
  @override
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      cubit.getLeadByIdForManager(
        id: "${cubit.selectedLead?.id}",
        managerId:
                  ...
                  Center(
                    child: ProfilePicture(
                      ...
                      imageUrl: cubit.lead?.profilePic != "" &&
                          ...
                          ? '${F.baseUrl}/managers/${authCubit?.user?.managerDetail?[authCubit?.managerIndex ?? 0].id ?? 0}/images/lead/${cubit.lead?.id}'
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                ...
                                Navigator.pushNamed(
                                    context, ManagerAppEditLead.route);
                              },
                              child: Container(
                                width: 24.w,
                                height: 24.w,
                      ...
                      Center(
                        child: Button(
                          ...
                          onTap: () {
                            ...
                            Navigator.pushNamed(
                                context, ManagerAppLeadFollowUpDetails.route);
                          },
