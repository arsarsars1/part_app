...
class ManagerAppSalaryDetails extends StatefulWidget {
  static const route = '/trainer/manager-app-salary-details';

  final bool trainer;

  const ManagerAppSalaryDetails({super.key, required this.trainer});

  @override
  State<ManagerAppSalaryDetails> createState() =>
      _ManagerAppSalaryDetailsState();
}

class _ManagerAppSalaryDetailsState extends State<ManagerAppSalaryDetails> {
            ...
            child: Button(
              onTap: () {
                ...
                if (widget.trainer) {
                  ...
                  Navigator.pushNamed(
                      context, ManagerAppAddTrainerBranches.route);
                } else {
