...
class ManagerAppAddOrEditSalary extends StatefulWidget {
  static const route = '/fees/manager-app-add-salary';
  const ManagerAppAddOrEditSalary({super.key});

  @override
  State<ManagerAppAddOrEditSalary> createState() => _AddOrEditSalaryState();
}

class _AddOrEditSalaryState extends State<ManagerAppAddOrEditSalary> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      await trainerCubit.getSalaryInvoiceForManager(
          trainerCubit.slipDetails?.id,
          managerId: authCubit
      ...
      body: BlocConsumer<TrainerCubit, TrainerState>(
        listener: (context, state) {
          if (state is AddedSalary) {
            ...
            trainerCubit.getSalaryInvoiceForManager(
                                ...
                                onTap: () {
                                  ...
                                  CommonDialog(
                                    ...
                                    onTap: () {
                                      ...
                                      trainerCubit.deleteSalaryForManager(
                                          slipId: trainerCubit
                                  ...
                                  CommonDialog(
                                    ...
                                    onTap: () {
                                      ...
                                      if (formKey1.currentState!.validate()) {
                                        Navigator.pop(context);
                                        trainerCubit.editSalaryForManager({
                                          'new_date': date,
                                          'new_amount': amount,
                                          'reason': reason
                                        },
                            ...
                            child: Button(
                              onTap: () {
                                if (formKey.currentState!.validate()) {
                                  trainerCubit.addSalaryForManager(
                                      managerId: authCubit
                                              ?.user
                                              ?.managerDetail?[
