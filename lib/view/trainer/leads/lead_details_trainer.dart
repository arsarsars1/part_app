...
class LeadTrainerDetails extends StatefulWidget {
  static const route = '/leads/details-trainer';
  const LeadTrainerDetails({super.key});

  @override
  State<LeadTrainerDetails> createState() => _LeadTrainerDetailsState();
}
