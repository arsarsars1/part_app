...
class AddTrainerLead extends StatefulWidget {
  static const route = '/leads/add-trainer';
  const AddTrainerLead({super.key});

  @override
  State<AddTrainerLead> createState() => _AddTrainerLeadState();
}

class _AddTrainerLeadState extends State<AddTrainerLead> {
  String? status;
  String? name;
  String? age;
  String? gender;
                    ...
                    child: Button(
                      onTap: () {
                        if (formKey.currentState!.validate()) {
                          ...
                          context
                              .read<LeadsCubit>()
                              .createTrainerLead(request, idTrainer: trainerId);
                        }
                      },
                      title: 'Add Lead',
                    ),
