...
class AllTrainerFollowUpView extends StatefulWidget {
  static const route = '/leads/all-followups-trainer';
  const AllTrainerFollowUpView({super.key});

  @override
  State<AllTrainerFollowUpView> createState() => _AllTrainerFollowUpViewState();
}
...
class _AllTrainerFollowUpViewState extends State<AllTrainerFollowUpView> {
  ...
  void doSearch(bool clean) {
    context.read<LeadsCubit>().getTrainerLeadList(
          trainerId: trainerId,
          branchId: branchId,
          batchId: batch?.id,
