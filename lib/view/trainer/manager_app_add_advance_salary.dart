...
class ManagerAppAddAdvanceSalaryPage extends StatefulWidget {
  static const route = '/manager-app-add-advance-salary';
  const ManagerAppAddAdvanceSalaryPage({super.key});

  @override
  State<ManagerAppAddAdvanceSalaryPage> createState() => _AddAdvanceSalaryPageState();
}

class _AddAdvanceSalaryPageState extends State<ManagerAppAddAdvanceSalaryPage> {
