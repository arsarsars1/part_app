...
class ManagerAppCalenderEvent extends StatefulWidget {
  static const route = '/manager-app-calender-event';
  const ManagerAppCalenderEvent({super.key});

  @override
  State<ManagerAppCalenderEvent> createState() =>
      _ManagerAppCalenderEventState();
}

class _ManagerAppCalenderEventState extends State<ManagerAppCalenderEvent> {
  @override
  void initState() {
    var cubit = context.read<HomeCubit>();
    var authCubit = context.read<AuthCubit>();
    cubit.getCalenderEventsForManager(
        managerId:
            authCubit.user?.managerDetail?[authCubit.managerIndex].id ?? 0,
        date: cubit.selectedDate.toServerYMD());
    super.initState();
  }
