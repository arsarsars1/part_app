...
class TrainerAppCalenderEvent extends StatefulWidget {
  static const route = '/trainer-app-calender-event';
  const TrainerAppCalenderEvent({super.key});

  @override
  State<TrainerAppCalenderEvent> createState() =>
      _TrainerAppCalenderEventState();
}

class _TrainerAppCalenderEventState extends State<TrainerAppCalenderEvent> {
  @override
  void initState() {
    var cubit = context.read<HomeCubit>();
    var authCubit = context.read<AuthCubit>();
    cubit.getCalenderEventsForTrainer(
        trainerId:
