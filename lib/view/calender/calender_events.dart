...
class _CalenderEventState extends State<CalenderEvent> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
          future: context.read<HomeCubit>().getCalenderEvents(
              date: context.read<HomeCubit>().selectedDate.toServerYMD()),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              ListView.builder(
                                  ...
                                  shrinkWrap: true,
                                  itemCount:
                                      cubit.trainerSalaryPayments?.length,
