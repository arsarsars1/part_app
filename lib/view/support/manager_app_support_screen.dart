...
class ManagerAppSupportScreen extends StatefulWidget {
  const ManagerAppSupportScreen({super.key});

  @override
  State<ManagerAppSupportScreen> createState() =>
      _TrainerAppSupportScreenState();
}

class _TrainerAppSupportScreenState extends State<ManagerAppSupportScreen> {
                ...
                child: Button(
                  onTap: () async {
                    if (formKey.currentState!.validate()) {
                      int? res = await cubit?.sendSupportRequestForManager(
                          authCubit
                                  ?.user
