...
class _EditLeadState extends State<EditLead> {
  ...
  Widget build(BuildContext context) {
    ...
    leadStatusController.text = cubit.selectedLead?.leadStatus ?? "";
    return Scaffold(
      key: scaffoldKey,
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  CommonField(
                    title: 'Batch',
                    initialValue: cubit.selectedLead?.batch?.batchName,
                  ...
                  CommonField(
                    ...
                    initialValue: cubit.selectedLead?.followUps?[0].followUpDate
                        ?.toDDMMMYYY(),
                    length: 50,
                    maxLines: 1,
                    disabled: true,
                  ...
                  CommonField(
                    ...
                    initialValue: cubit.selectedLead?.followUps?[0].followUpTime
                        ?.toAmPM(),
                    length: 50,
                    maxLines: 1,
                    disabled: true,
                  ...
                  CommonField(
                    ...
                    initialValue: cubit.selectedLead?.assignedTo?.name,
                    title: 'Assign',
