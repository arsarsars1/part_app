...
class ManagerAppEditClassLink extends StatefulWidget {
  static const route = '/manager-app-edit-class-link';

  const ManagerAppEditClassLink({super.key});

  @override
  State<ManagerAppEditClassLink> createState() =>
      _ManagerAppEditClassLinkState();
}

class _ManagerAppEditClassLinkState extends State<ManagerAppEditClassLink> {
  int? branchId;
  BatchModel? batch;
  int? batchId;
  DateTime? date;
                  ...
                  child: Button(
                    ...
                    onTap: () {
                      if (formKey.currentState!.validate()) {
                        ...
                        batchCubit.updateClassLinkForManager(
                          authCubit
                                  ?.user
