...
class TrainerAppAttendanceAdd extends StatefulWidget {
  static const route = '/trainer-app-add-attendance';

  const TrainerAppAttendanceAdd({Key? key}) : super(key: key);

  @override
  State<TrainerAppAttendanceAdd> createState() =>
      _TrainerAppAttendanceAddState();
}

class _TrainerAppAttendanceAddState extends State<TrainerAppAttendanceAdd> {
  int? branchId;
  String? query;
  String? temp;
                                        ...
                                        children: [
                                          UserImage(
                                            profilePic: student.profilePic != ""
                                                ? '${F.baseUrl}'
                                                    '/trainer/${authCubit?.user?.trainerDetail?[authCubit?.trainerIndex ?? 0].id}/images/trainer/'
