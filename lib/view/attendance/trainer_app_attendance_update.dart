...
class TrainerAppAttendanceUpdate extends StatefulWidget {
  ...
  State<TrainerAppAttendanceUpdate> createState() =>
      _TrainerAppAttendanceUpdateState();
}

class _TrainerAppAttendanceUpdateState
    extends State<TrainerAppAttendanceUpdate> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      await cubit.getAttendenceTakenForTrainer(
          trainerId: authCubit
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // TrainerAppAttendanceUpdateListItem(
          ...
          //       );
          //     }
          //     return TrainerAppAttendanceUpdateListItem(
          //       students: studentCubit.students ?? [],
          //       onSelect: (StudentModel student) async {},
          //     );
          //   },
