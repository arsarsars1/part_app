...
class TrainerAppAttendanceClassPicker extends StatefulWidget {
  final DateTime date;
  final List<EventModel>? eventList;

  const TrainerAppAttendanceClassPicker({
    super.key,
    required this.date,
    this.eventList,
  });
  ...
  @override
  State<TrainerAppAttendanceClassPicker> createState() =>
      _TrainerAppAttendanceClassPickerState();
}

class _TrainerAppAttendanceClassPickerState
    extends State<TrainerAppAttendanceClassPicker> {
  @override
