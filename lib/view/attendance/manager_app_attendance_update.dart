...
class ManagerAppAttendanceUpdate extends StatefulWidget {
  static const route = '/manager-app-update_attendance';

  const ManagerAppAttendanceUpdate({super.key});

  @override
  State<ManagerAppAttendanceUpdate> createState() =>
      _ManagerAppAttendanceUpdateState();
}

class _ManagerAppAttendanceUpdateState
    extends State<ManagerAppAttendanceUpdate> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      await cubit.getAttendenceTakenForManager(
          managerId: authCubit
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // ManagerAppAttendanceUpdateListItem(
          ...
          //       );
          //     }
          //     return ManagerAppAttendanceUpdateListItem(
          //       students: studentCubit.students ?? [],
          //       onSelect: (StudentModel student) async {},
          //     );
          //   },
