...
class ManagerAppAttendanceAdd extends StatefulWidget {
  static const route = '/manager-app-add-attendance';

  const ManagerAppAttendanceAdd({super.key});

  @override
  State<ManagerAppAttendanceAdd> createState() =>
      _ManagerAppAttendanceAddState();
}

class _ManagerAppAttendanceAddState extends State<ManagerAppAttendanceAdd> {
  int? branchId;
  String? query;
  String? temp;
  ...
  Future<void> doSearch(bool clean) async {
    await context.read<StudentCubit>().getStudentsForManager(
          managerId: authCubit
                                        ...
                                        children: [
                                          UserImage(
                                            profilePic: student.profilePic != ""
                                                ? '${F.baseUrl}'
                                                    '/manager/${authCubit?.user?.managerDetail?[authCubit?.managerIndex ?? 0].id}/images/manager/'
