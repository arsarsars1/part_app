...
class ManagerAppAddStudent extends StatefulWidget {
  static const route = '/manager-app-students/add';

  const ManagerAppAddStudent({super.key});

  @override
  State<ManagerAppAddStudent> createState() => _ManagerAppAddStudentState();
}

class _ManagerAppAddStudentState extends State<ManagerAppAddStudent> {
