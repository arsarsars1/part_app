...
class TrainerAppAssignStudentBatch extends StatefulWidget {
  static const route = '/trainer-app-students/add/assign-batch';
  ...
  State<TrainerAppAssignStudentBatch> createState() =>
      _TrainerAppAssignStudentBatchState();
}

class _TrainerAppAssignStudentBatchState
    extends State<TrainerAppAssignStudentBatch> {
