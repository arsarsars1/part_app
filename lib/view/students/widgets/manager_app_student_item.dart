...
class ManagerAppStudentItem extends StatelessWidget {
  final int? managerId;
  final StudentModel student;
  final VoidCallback onTap;

  const ManagerAppStudentItem(
      {super.key, required this.student, required this.onTap, this.managerId});
                ...
                children: [
                  UserImage(
                    profilePic: student.profilePic != ""
                        ? managerId != null
                            ? '${F.baseUrl}'
                                '/managers/$managerId/images/student/'
