...
class TrainerAppStudentBatchPicker extends StatefulWidget {
  final String status;
  final int studentId;
  ...
  const TrainerAppStudentBatchPicker({
    super.key,
  ...
  @override
  State<TrainerAppStudentBatchPicker> createState() =>
      _TrainerAppStudentBatchPickerState();
}

class _TrainerAppStudentBatchPickerState
    extends State<TrainerAppStudentBatchPicker> {
