...
class ManagerAppStudentAttendanceCalenderView extends StatefulWidget {
  static const route = '/manager-app-student-calender-view';

  const ManagerAppStudentAttendanceCalenderView({super.key});

  @override
  State<ManagerAppStudentAttendanceCalenderView> createState() =>
      _ManagerAppStudentAttendanceCalenderViewState();
}

class _ManagerAppStudentAttendanceCalenderViewState
    extends State<ManagerAppStudentAttendanceCalenderView> {
  bool isActive = true;
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      await studentCubic.getStudentBatchesForManagers(
        clean: true,
        managerId:
      ...
      cubit.id = batch?.id ?? 0;
      await cubit.getAttendenceOfStudentOfMonthForManager(
          managerId: authCubit
