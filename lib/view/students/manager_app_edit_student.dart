...
class ManagerAppEditStudent extends StatefulWidget {
  static const route = '/manager-app-students/edit';

  const ManagerAppEditStudent({super.key});

  @override
  State<ManagerAppEditStudent> createState() => _ManagerAppEditStudentState();
}

class _ManagerAppEditStudentState extends State<ManagerAppEditStudent> {
      ...
      body: BlocListener<StudentCubit, StudentState>(
        listener: (context, state) {
          if (state is UpdatingStudent) {
            ...
            Navigator.popUntil(
              context,
              ModalRoute.withName(ManagerAppStudentDetails.route),
            );
