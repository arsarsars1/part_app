...
class ManagerAppAssignBatch extends StatefulWidget {
  static const route = '/manager-app-students/add/batches';
  final bool editStudent;

  const ManagerAppAssignBatch({super.key, required this.editStudent});

  @override
  State<ManagerAppAssignBatch> createState() => _ManagerAppAssignBatchState();
}

class _ManagerAppAssignBatchState extends State<ManagerAppAssignBatch> {
  int? branchId;
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return BatchItem(
                          ...
                          onAddToBatch: () {
                            ...
                            Navigator.pushNamed(
                              context,
                              ManagerAppAssignStudentBatch.route,
