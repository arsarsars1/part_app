...
import 'package:part_app/view/students/widgets/manager_app_student_item.dart';
import 'package:part_app/view_model/cubits.dart';

class ManagerAppStudentsView extends StatefulWidget {
  static const route = '/manager-app-students';

  const ManagerAppStudentsView({super.key});

  @override
  State<ManagerAppStudentsView> createState() => _ManagerAppStudentsViewState();
}

class _ManagerAppStudentsViewState extends State<ManagerAppStudentsView> {
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return ManagerAppStudentItem(
                                      ...
                                      student: student,
                                      onTap: () {
                                        cubit.studentDetailsForManager(
                                            managerId: authCubit
                                                    ?.user
  ...
  void doSearch(bool clean) {
    context.read<StudentCubit>().getStudentsForManager(
          managerId: authCubit
                  ?.user?.managerDetail?[authCubit?.managerIndex ?? 0].id ??
              0,
          batchId: batch?.id,
