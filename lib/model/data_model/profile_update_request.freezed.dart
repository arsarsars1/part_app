...
class _$_ProfileUpdateRequest implements _ProfileUpdateRequest {
  ...
  @override
  String toString() {
    return 'ProfileUpdateRequest(name: $name, mobileNo: $mobileNo, countryCode: $countryCode, email: $email, gender: $gender, whatsappNo: $whatsappNo, academyName: $academyName, dob: $dob, profilePic: $profilePic)';
  }
