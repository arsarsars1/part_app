...
BatchResponsePivot _$BatchResponsePivotFromJson(Map<String, dynamic> json) {
  return _BatchResponsePivot.fromJson(json);
}

/// @nodoc
mixin _$BatchResponsePivot {
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $BatchResponsePivotCopyWith<BatchResponsePivot> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BatchResponsePivotCopyWith<$Res> {
  factory $BatchResponsePivotCopyWith(
          BatchResponsePivot value, $Res Function(BatchResponsePivot) then) =
      _$BatchResponsePivotCopyWithImpl<$Res, BatchResponsePivot>;
  @useResult
  $Res call(
      {int? studentDetailId,
      int? batchId,
...
/// @nodoc
class _$BatchResponsePivotCopyWithImpl<$Res, $Val extends BatchResponsePivot>
    implements $BatchResponsePivotCopyWith<$Res> {
  _$BatchResponsePivotCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_BatchResponsePivotCopyWith<$Res>
    implements $BatchResponsePivotCopyWith<$Res> {
  factory _$$_BatchResponsePivotCopyWith(_$_BatchResponsePivot value,
          $Res Function(_$_BatchResponsePivot) then) =
      __$$_BatchResponsePivotCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? studentDetailId,
...
/// @nodoc
class __$$_BatchResponsePivotCopyWithImpl<$Res>
    extends _$BatchResponsePivotCopyWithImpl<$Res, _$_BatchResponsePivot>
    implements _$$_BatchResponsePivotCopyWith<$Res> {
  __$$_BatchResponsePivotCopyWithImpl(
      _$_BatchResponsePivot _value, $Res Function(_$_BatchResponsePivot) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_BatchResponsePivot(
      studentDetailId: freezed == studentDetailId
          ? _value.studentDetailId
          : studentDetailId // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$_BatchResponsePivot implements _BatchResponsePivot {
  const _$_BatchResponsePivot(
  ...
  factory _$_BatchResponsePivot.fromJson(Map<String, dynamic> json) =>
      _$$_BatchResponsePivotFromJson(json);
  ...
  @override
  String toString() {
    return 'BatchResponsePivot(studentDetailId: $studentDetailId, batchId: $batchId, noOfClasses: $noOfClasses, feeType: $feeType, feeAmount: $feeAmount, admissionFees: $admissionFees, cycle: $cycle, doj: $doj, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_BatchResponsePivot &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_BatchResponsePivotCopyWith<_$_BatchResponsePivot> get copyWith =>
      __$$_BatchResponsePivotCopyWithImpl<_$_BatchResponsePivot>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_BatchResponsePivotToJson(
      this,
    );
  }
}

abstract class _BatchResponsePivot implements BatchResponsePivot {
  const factory _BatchResponsePivot(
      {final int? studentDetailId,
      final int? batchId,
      final dynamic? noOfClasses,
      final String? feeType,
      ...
      final DateTime? doj,
      final DateTime? createdAt,
      final DateTime? updatedAt}) = _$_BatchResponsePivot;

  factory _BatchResponsePivot.fromJson(Map<String, dynamic> json) =
      _$_BatchResponsePivot.fromJson;
