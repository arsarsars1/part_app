...
class _$LeadRequestImpl implements _LeadRequest {
  ...
  @override
  String toString() {
    return 'LeadRequest(branchId: $branchId, batchId: $batchId, leadStatus: $leadStatus, name: $name, mobileNo: $mobileNo, gender: $gender, age: $age, whatsappNo: $whatsappNo, email: $email, followUpDate: $followUpDate, followUpTime: $followUpTime, assignedToId: $assignedToId, assignedToType: $assignedToType, followUpComment: $followUpComment)';
  }
