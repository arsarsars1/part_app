...
CalenderEventsList calenderEventsListFromJson(String str) => CalenderEventsList.fromJson(json.decode(str));

String calenderEventsListToJson(CalenderEventsList data) => json.encode(data.toJson());
...
class CalenderEventsList {
    ...
    factory CalenderEventsList.fromJson(Map<String, dynamic> json) => CalenderEventsList(
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        trainerSalaryPayments: json["trainer_salary_payments"] == null ? [] : List<TrainerSalaryPayment>.from(json["trainer_salary_payments"]!.map((x) => TrainerSalaryPayment.fromJson(x))),
        scheduledClasses: json["scheduled_classes"] == null ? [] : List<ScheduledClass>.from(json["scheduled_classes"]!.map((x) => ScheduledClass.fromJson(x))),
        rescheduledClasses: json["rescheduled_classes"] == null ? [] : List<ScheduledClass>.from(json["rescheduled_classes"]!.map((x) => ScheduledClass.fromJson(x))),
        studentsJoined: json["students_joined"] == null ? [] : List<StudentsJoined>.from(json["students_joined"]!.map((x) => StudentsJoined.fromJson(x))),
        trainersJoined: json["trainers_joined"] == null ? [] : List<TrainersJoined>.from(json["trainers_joined"]!.map((x) => TrainersJoined.fromJson(x))),
        followUpLeads: json["follow_up_leads"] == null ? [] : List<Lead>.from(json["follow_up_leads"]!.map((x) => Lead.fromJson(x))),
        newLeads: json["new_leads"] == null ? [] : List<Lead>.from(json["new_leads"]!.map((x) => Lead.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "fee_payments": feePayments,
        "trainer_salary_payments": trainerSalaryPayments == null ? [] : List<dynamic>.from(trainerSalaryPayments!.map((x) => x.toJson())),
        "scheduled_classes": scheduledClasses == null ? [] : List<dynamic>.from(scheduledClasses!.map((x) => x.toJson())),
        "rescheduled_classes": rescheduledClasses == null ? [] : List<dynamic>.from(rescheduledClasses!.map((x) => x.toJson())),
        "students_joined": studentsJoined == null ? [] : List<dynamic>.from(studentsJoined!.map((x) => x.toJson())),
        "trainers_joined": trainersJoined == null ? [] : List<dynamic>.from(trainersJoined!.map((x) => x.toJson())),
        "follow_up_leads": followUpLeads == null ? [] : List<dynamic>.from(followUpLeads!.map((x) => x.toJson())),
        "new_leads": newLeads == null ? [] : List<dynamic>.from(newLeads!.map((x) => x.toJson())),
    };
}
...
class Lead {
    ...
    factory Lead.fromJson(Map<String, dynamic> json) => Lead(
        ...
        branch: json["branch"] == null ? null : FollowUpLeadBranch.fromJson(json["branch"]),
        batch: json["batch"] == null ? null : FollowUpLeadBatch.fromJson(json["batch"]),
        assignedTo: json["assigned_to"] == null ? null : AssignedTo.fromJson(json["assigned_to"]),
        followUps: json["follow_ups"] == null ? [] : List<FollowUp>.from(json["follow_ups"]!.map((x) => FollowUp.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "follow_ups": followUps == null ? [] : List<dynamic>.from(followUps!.map((x) => x.toJson())),
    };
}
...
class FollowUpLeadBatch {
    ...
    factory FollowUpLeadBatch.fromJson(Map<String, dynamic> json) => FollowUpLeadBatch(
        id: json["id"],
...
class FollowUpLeadBranch {
    ...
    factory FollowUpLeadBranch.fromJson(Map<String, dynamic> json) => FollowUpLeadBranch(
        id: json["id"],
        branchName: json["branch_name"],
        stateId: json["state_id"],
        districtId: json["district_id"],
        state: json["state"] == null ? null : StateDetail.fromJson(json["state"]),
...
class TrainerSalaryPayment {
    ...
    factory TrainerSalaryPayment.fromJson(Map<String, dynamic> json) => TrainerSalaryPayment(
        id: json["id"],
        ...
        trainerSalarySlip: json["trainer_salary_slip"] == null ? null : TrainerSalarySlip.fromJson(json["trainer_salary_slip"]),
    );
...
class TrainerDetail {
    int? id;
    String? name;
    List<TrainerDetailBranch>? branches;
    ...
    factory TrainerDetail.fromJson(Map<String, dynamic> json) => TrainerDetail(
        id: json["id"],
        name: json["name"],
        branches: json["branches"] == null ? [] : List<TrainerDetailBranch>.from(json["branches"]!.map((x) => TrainerDetailBranch.fromJson(x))),
        batches: json["batches"] == null ? [] : List<BatchElement>.from(json["batches"]!.map((x) => BatchElement.fromJson(x))),
    );
...
class BatchElement {
    ...
    factory BatchElement.fromJson(Map<String, dynamic> json) => BatchElement(
        ...
        batchDetail: json["batch_detail"] == null ? [] : List<dynamic>.from(json["batch_detail"]!.map((x) => x)),
        trainers: json["trainers"] == null ? [] : List<dynamic>.from(json["trainers"]!.map((x) => x)),
        course: json["course"],
    ...
    Map<String, dynamic> toJson() => {
        "batch_name": batchName,
        "pivot": pivot?.toJson(),
        "batch_detail": batchDetail == null ? [] : List<dynamic>.from(batchDetail!.map((x) => x)),
        "trainers": trainers == null ? [] : List<dynamic>.from(trainers!.map((x) => x)),
        "course": course,
        "subject": subject,
        "branch": branch,
    };
...
class TrainerDetailBranch {
    ...
    factory TrainerDetailBranch.fromJson(Map<String, dynamic> json) => TrainerDetailBranch(
        branchName: json["branch_name"],
        pivot: json["pivot"] == null ? null : Pivot.fromJson(json["pivot"]),
...
class TrainersJoined {
    ...
    factory TrainersJoined.fromJson(Map<String, dynamic> json) => TrainersJoined(
        ...
        isActive: json["is_active"],
        branches: json["branches"] == null ? [] : List<TrainersJoinedBranch>.from(json["branches"]!.map((x) => TrainersJoinedBranch.fromJson(x))),
    );
...
class TrainersJoinedBranch {
    ...
    factory TrainersJoinedBranch.fromJson(Map<String, dynamic> json) => TrainersJoinedBranch(
        id: json["id"],
        branchName: json["branch_name"],
        academyId: json["academy_id"],
